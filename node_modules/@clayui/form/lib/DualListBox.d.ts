...
declare const ClayDualListBox: ({ ariaLabels, className, disabled, disableLTR, disableRTL, items, left, onItemsChange, right, size, spritemap, ...otherProps }: IProps) => JSX.Element;
