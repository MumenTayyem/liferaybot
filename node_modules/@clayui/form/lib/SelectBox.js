...
var _excluded = ["ariaLabels", "buttonAlignment", "className", "disabled", "id", "items", "label", "multiple", "onItemsChange", "onSelectChange", "showArrows", "size", "spritemap", "value"];
...
var ClaySelectBox = function ClaySelectBox(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: (0, _classnames.default)('reorder-label', {
      disabled: disabled
    }),
    htmlFor: id
