...
var _excluded = ["ariaLabels", "className", "disabled", "disableLTR", "disableRTL", "items", "left", "onItemsChange", "right", "size", "spritemap"];
...
var ClayDualListBox = function ClayDualListBox(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({}, otherProps, {
    ...
    disabled: leftSelected.length === 0 || disableLTR || disabled,
    ...
    disabled: rightSelected.length === 0 || disableRTL || disabled,
    displayType: "secondary",
    onClick: function onClick() {
