...
export interface IMultipleSelectionProps<T extends Record<string, any>> extends IMultipleSelection, Pick<ITreeProps<T>, 'nestedKey'>, Pick<ICollectionProps<T>, 'items'> {
    selectionMode?: SelectionMode;
 ...
 */
export declare function useMultipleSelection<T extends Record<string, any>>(props: IMultipleSelectionProps<T>): IMultipleSelectionState;
export {};
