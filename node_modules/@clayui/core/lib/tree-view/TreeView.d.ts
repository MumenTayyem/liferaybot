...
interface ITreeViewProps<T extends Record<string, any>> extends Omit<React.HTMLAttributes<HTMLUListElement>, 'children' | 'onSelect'>, ITreeProps<T>, ICollectionProps<T> {
    /**
...
export declare function TreeView<T extends Record<string, any>>(props: ITreeViewProps<T>): JSX.Element & {
