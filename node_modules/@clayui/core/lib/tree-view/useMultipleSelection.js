...
function useMultipleSelection(props) {
  ...
  var _useControlledState = (0, _shared.useControlledState)({
    ...
    value: props.selectedKeys
      ...
      setSelectionKeys = _useControlledState2[1],
  ...
  (0, _react.useEffect)(function () {
    if (!isFirstRender && props.selectionMode === 'multiple-recursive' && !isUncontrolled) {
      ...
      props.layoutKeys.current.forEach(function (keyMap, key) {
        if (!keyMap) {
          return false;
        }
        ...
        if (children.every(function (key) {
          return selectedKeys.has(key);
        })) {
          newSelectedKeys.add(key);
          indeterminateKeys.current.delete(key);
        } else if (children.some(function (key) {
          return selectedKeys.has(key);
        })) {
