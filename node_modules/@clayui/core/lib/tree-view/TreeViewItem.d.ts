...
export declare function TreeViewItemStack({ actions, children, disabled, expandable, expanderDisabled, isNonDraggrable, labelId, loading, onLoadMore, tabIndex, ...otherProps }: ITreeViewItemStackProps): JSX.Element;
