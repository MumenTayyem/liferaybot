...
var _excluded = ["UNSAFE_behavior", "UNSAFE_menuClassName", "active", "as", "children", "className", "defaultActive", "defaultSelectedKey", "direction", "disabled", "id", "items", "messages", "native", "onActiveChange", "onSelectionChange", "placeholder", "selectedKey", "width"];
...
function Picker(_ref) {
  var _triggerRef$current, _collection$getItem;

  var UNSAFE_behavior = _ref.UNSAFE_behavior,
      UNSAFE_menuClassName = _ref.UNSAFE_menuClassName,
  ...
  var _useControlledState3 = (0, _shared.useControlledState)({
    ...
    value: externalSelectedKey
      ...
      setSelectedKey = _useControlledState4[1]; // We initialize the collection in the picker and then pass it down so the
  ...
  var _useState = (0, _react.useState)(function () {
    return selectedKey || selectedKey === 0 ? selectedKey : collection.getFirstItem().key;
  }),
  ...
  (0, _react.useEffect)(function () {
    if (announcerAPI.current && (0, _shared.isAppleDevice)() && activeDescendant && active) {
      var item = collection.getItem(activeDescendant);

      if (!item) {
        return;
      }

      announcerAPI.current.announce(selectedKey === activeDescendant ? (0, _shared.sub)(messages.itemSelected, [item.value]) : "".concat(item.value)); // Announces item description with delay to replace combobox description.

      setTimeout(function () {
        announcerAPI.current.announce(messages.itemDescribedby);
      }, 1000);
    }
  }, [active]); // When the items are updated, the visual focus is stale, meaning that when
  ...
  var _useState3 = (0, _react.useState)(null),
      ...
      isArrowVisible = _useState4[0],
      setIsArrowVisible = _useState4[1];
  ...
  (0, _react.useEffect)(function () {
    ...
    function onScroll(event) {
      ...
      var scrollHeightMax = event.target.scrollHeight - event.target.clientHeight - THRESHOLD;
    ...
    (_listRef$current = listRef.current) === null || _listRef$current === void 0 ? void 0 : _listRef$current.addEventListener('scroll', onScroll, true);
    return function () {
      var _listRef$current2;

      return (_listRef$current2 = listRef.current) === null || _listRef$current2 === void 0 ? void 0 : _listRef$current2.removeEventListener('scroll', onScroll, true);
    };
  }, [active]);
  var onMoveFocus = (0, _react.useCallback)(function (key, position, list) {
    var _list;
    ...
    var option = (_list = list[key === 'PageUp' ? position - 10 : position + 10]) !== null && _list !== void 0 ? _list : list[key === 'PageUp' ? 0 : list.length - 1];
    accessibilityFocus(option instanceof HTMLElement ? option : document.getElementById(String(option)));
  }, [accessibilityFocus]);
  var context = {
  ...
  var clientWidth = ((_triggerRef$current = triggerRef.current) === null || _triggerRef$current === void 0 ? void 0 : _triggerRef$current.clientWidth) || 0;
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_liveAnnouncer.LiveAnnouncer, {
        ...
        case 'PageDown':
          {
            ...
            onMoveFocus(event.key, list.findIndex(function (element) {
              return element.getAttribute('id') === String(activeDescendant);
            }), list);
            break;
          }
    ...
    tabIndex: 0,
    type: "button"
  }), selectedKey ? (_collection$getItem = collection.getItem(selectedKey)) === null || _collection$getItem === void 0 ? void 0 : _collection$getItem.value : placeholder), active && /*#__PURE__*/_react.default.createElement(_shared.Overlay, {
    ...
    onClose: function onClose(action) {
      if (isFocusVisible() && activeDescendant && action === 'blur') {
        ...
        var _key = selectedKey || selectedKey === 0 ? selectedKey : collection.getFirstItem().key;
    ...
    className: (0, _classnames.default)('dropdown-menu dropdown-menu-indicator-start dropdown-menu-select dropdown-menu-width-shrink show', {
    ...
    style: {
      maxWidth: 'none',
      minWidth: !width ? "".concat(Math.max(160, clientWidth), "px") : undefined,
      width: typeof width === 'number' ? "".concat(Math.max(width, clientWidth), "px") : undefined
    }
  }, UNSAFE_behavior === 'secondary' && (isArrowVisible === 'top' || isArrowVisible === 'both') && /*#__PURE__*/_react.default.createElement(_button.default, {
    "aria-hidden": "true",
    ...
    onClick: function onClick() {
      ...
      onMoveFocus('PageUp', list.findIndex(function (item) {
        return item === activeDescendant;
      }), list);
    ...
    onFocus: function onFocus() {
      ...
      return (_triggerRef$current3 = triggerRef.current) === null || _triggerRef$current3 === void 0 ? void 0 : _triggerRef$current3.focus();
    },
    ref: listRef,
    role: "listbox",
    tabIndex: -1
    ...
    collection: collection
  }))), UNSAFE_behavior === 'secondary' && (isArrowVisible === 'bottom' || isArrowVisible === 'both') && /*#__PURE__*/_react.default.createElement(_button.default, {
    "aria-hidden": "true",
    ...
    onClick: function onClick() {
      ...
      var list = collection.getItems();
      onMoveFocus('PageDown', list.findIndex(function (item) {
        return item === activeDescendant;
      }), list);
      (_triggerRef$current4 = triggerRef.current) === null || _triggerRef$current4 === void 0 ? void 0 : _triggerRef$current4.focus();
    },
    tabIndex: -1
  }, /*#__PURE__*/_react.default.createElement(_icon.default, {
    symbol: "caret-bottom"
